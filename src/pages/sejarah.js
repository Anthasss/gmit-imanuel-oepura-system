      ...
      <div className="bg-gray-50">
          ...
          <div className="relative z-10 text-center text-white px-4">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light">
                Perjalanan panjang GMIT Imanuel Oepura dalam melayani dan berkarya untuk kemuliaan Tuhan dan kebaikan
                sesama
              </p>
            </div>
          </div>
        ...
        <div className="py-20 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in-up">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gray-800">Warisan Iman Yang Berkelanjutan</h2>
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-8">
                Lebih dari tujuh dekade, GMIT Imanuel Oepura telah menjadi saksi perubahan zaman sambil tetap
                mempertahankan nilai-nilai iman Kristen dan budaya lokal Timor. Setiap era membawa tantangan dan berkat
                tersendiri, namun komitmen untuk melayani tetap menjadi fondasi yang kokoh.
              </p>
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
                <blockquote className="text-2xl font-semibold text-blue-800 italic">
                  "Kami tidak hanya mewarisi gedung dan tradisi, tetapi juga semangat melayani yang telah diteruskan
        ...
        <div className="py-20 px-4 bg-gradient-to-br from-amber-50 to-orange-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-amber-800">Warisan Yang Kami Jaga</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
                ...
                <p className="text-amber-700 text-center leading-relaxed">
                  Liturgi dan tatacara ibadah yang memadukan unsur Reformed dengan kearifan lokal Timor, menciptakan
                  pengalaman spiritual yang autentik dan bermakna.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
                ...
                <p className="text-green-700 text-center leading-relaxed">
                  Pelestarian bahasa, adat istiadat, dan nilai-nilai budaya Timor yang diintegrasikan dengan ajaran
                  Kristen dalam kehidupan sehari-hari jemaat.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
                ...
                <p className="text-blue-700 text-center leading-relaxed">
                  Komitmen dalam melayani masyarakat melalui berbagai program sosial, pendidikan, dan pemberdayaan
        ...
        <div className="bg-gradient-to-r from-slate-800 to-blue-900 py-20 px-4 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Mari Menjadi Bagian dari Sejarah Ini</h2>
            <p className="text-lg md:text-xl mb-8 opacity-90">
              Sejarah tidak berhenti di masa lalu. Anda bisa menjadi bagian dari perjalanan iman dan pelayanan GMIT
              Imanuel Oepura ke depan.
            </p>
